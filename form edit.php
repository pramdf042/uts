...
if (isset($_POST['submit']))
{
    ...
    if($edit)//jika sukses
    {
        echo "<script>
            ...
            document.location='edit data.php';
            </script>";
    }
    //jika gagal
    else{
...
if (isset($_GET['hal']))
{
    ...
    $tampil=mysqli_query($koneksi," SELECT *FROM datasiswa WHERE idsiswa = '$_GET[id]'");
    $data=mysqli_fetch_array($tampil);
    if($data){
        $vID = $data['idsiswa'];
        $vNAMA = $data['namasiswa'];
        $vNIS = $data['nis'];
        $vKELAS = $data['kelas'];
        $vMASUK = $data['tahunmasuk'];
    }
    }
}
?>
