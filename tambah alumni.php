...
{
    $submit = mysqli_query($koneksi , "INSERT INTO alumni (no_ijasah,nama_alumni,alamat,tahunlulus)
        Values ('$_POST[NO]',
                '$_POST[NAMA]',
                '$_POST[ALAMAT]',
                '$_POST[LULUS]')
    ...
    if($submit)
    {
        echo "<script>
            ...
            document.location='admin alumni.php';
            </script>";
    }
    else{
        echo "<script>
...
<body>
    ...
    <!-- Menu -->
    <h1 align="center">TAMBAH DATA ALUMNI</h1>
    <div class="container">
		<div class="card-body">
			...
			<div class="form-group mb-3">
				<label>ALAMAT</label>
				<input type="text" name="ALAMAT" value="<?=@$vALAMAT?>" class="form-control" placeholder="ALAMAT ALUMNI" required>
			</div>
