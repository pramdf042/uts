...
if (isset($_POST['submit']))
{
    if($_GET['hal']=='edit')
    {
        $edit = mysqli_query($koneksi , "UPDATE nilaisiswa SET 
                                         id_siswa= '$_POST[ID]',
    ...
    if($edit)//jika sukses
    {
        echo "<script>
            ...
            document.location='edit nilai.php';
            </script>";
    }
    //jika gagal
    else{
...
if (isset($_GET['hal']))
{
    ...
    $tampil=mysqli_query($koneksi," SELECT *FROM nilaisiswa WHERE id_siswa = '$_GET[id]'");
    ...
    <div class="container">
		<div class="card-body">
			...
			<div class="form-group mb-3">
				...
				<input type="text" name="SEMESTER" value="<?=@$vSEMESTER?>" class="form-control" placeholder="SEMESTER SISWA" required>
			</div>
			<div class="form-group mb-3">
				<label>NILAI SISWA</label>
				<input type="text" name="NILAI" value="<?=@$vNILAI?>" class="form-control" placeholder="NILAI SISWA" required>
			</div>
            <br>
